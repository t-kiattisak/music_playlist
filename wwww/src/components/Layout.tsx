    ...
    <div className='bg-black'>
      <div className='h-16 flex items-center p-2 fixed top-0 left-0 right-0 bg-black z-50'>
        <div className='flex-1 flex items-center space-x-2'>
          ...
          <Button className='rounded-full h-12 w-12 bg-spotify-dark p-1'>
            <svg
              data-encore-id='icon'
              role='img'
              className='w-6 h-6 text-spotify-muted-light fill-current'
              aria-hidden='true'
              viewBox='0 0 24 24'
            >
          ...
          <div className='relative md:absolute left-0 right-0'>
            <div className='max-w-full md:max-w-[474px] mx-auto'>
              <Input
                placeholder='What do you want to play?'
                startIcon={<SearchIcon size={18} className='text-input' />}
                className='rounded-full text-white bg-spotify-dark'
              />
            </div>
          </div>
        </div>
        ...
        <div className='flex space-x-2 items-center'>
          ...
          <Avatar className='bg-spotify-dark items-center justify-center p-2 size-12'>
            <Avatar className='bg-spotify-purple items-center justify-center'>
              K
            </Avatar>
          </Avatar>
        </div>
      </div>
      <div className='fixed top-16 bottom-0 w-[345px]'>
      ...
      <div className='pt-2'>
        <div className='pt-16 pl-[345px]'>{children}</div>
      </div>
    </div>
  )
}
